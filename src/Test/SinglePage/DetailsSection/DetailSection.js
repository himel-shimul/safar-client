...
const DetailSection = () => {
    ...
    return (
        <div>
            <div className='grid grid-cols-1 lg:grid-cols-2 lg:p-4 p-2 w-full relative'>
                <div className='p-2 w-5/5'>
                    <LeftSide />
                </div>

                {/* right side / card */}
                <div className='flex justify-center '>
                    <div className='lg:p-6 p-2 lg:w-3/4'>
                        <div className='border rounded-lg lg:p-6 p-2' >
